...
Copernicus EMS operators graded 4 485 buildings in Rasuwa, Nepal, and recorded 3 438 of them destroyed, from imagery read 45 hours after the event.

This updates the version published earlier this week. Copernicus has since delivered a fourth graded area, Phosretar, and revised the grading for Bidur. Bharatpur and Kyundi are not yet delivered.
...
- Buildings graded: 4 485, of which 3 438 destroyed and 1 047 damaged
- Area mapped as affected: 13.7 km2, typed Landslide
- Roads: 69.1 km destroyed of 265.0 km graded
...
- Modelled loss: €42M to €45M
- Exposed value of the graded buildings: €54M
- Population inside the mapped area: 7 600
...
Those figures are this project's, computed on the footprint Copernicus mapped rather than on one of our own. An independent footprint count (Google Open Buildings) finds 4 346 structures inside the same polygons. Copernicus graded 4 485, at least as many; the destroyed share above is not read against a small sample.

## What the counts do not cover

Copernicus EMS marks 0.14 km2 of the ground it was asked to map as not analysed, 0.1% of the total. Nothing inside it is counted, by them or here.

Public infrastructure, agriculture and vehicles are outside the model. Only private built assets are counted.

## What is not known yet

Bharatpur, Kyundi are inside the activation and have not been graded yet, so nothing here counts them. What each building is worth comes from an aggregated national exposure dataset rather than from any local valuation. At the two lower damage grades, the share of that value lost is assumed. No official or industry cost figure has been published for this event.
...
```
Tier 1 of 3
[ok  ] IMAGERY: 1 post-event scenes
[ok  ] PROVENANCE: Extent mapped by Copernicus EMS operators from very high resolution imagery
[ok  ] EXTENT: 13.6 km² detected
[WARN] VERSUS_EMS: Own detection covers 0% of the 13.7 km2 Copernicus EMS mapped by hand
[ok  ] COVERAGE: 100% of the area observed
[ok  ] ASSESSABLE: The Copernicus EMS operators could assess 100% of the area
[ok  ] GRADED: 4485 buildings priced from their observed grade, 77% of them destroyed and costed at full replacement, which is definitional rather than assumed. The assumed range spans 7% of the upper bound.
[ok  ] EXPOSURE: 57,961,799 exposed
[ok  ] DAMAGE_RATIO: 81% damage ratio
```
